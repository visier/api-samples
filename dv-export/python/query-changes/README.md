...
This placeholder is replaced with actual values from the DV export files. For examples, see the `queries` path. For more information about list queries, see "Data Query" in [API Reference](https://docs.visier.com/developer/Default.htm#cshid=1051).
